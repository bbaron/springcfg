...
import cfg.model.AppConfigIntegrationTest;
...
privileged aspect AppConfigIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    AppConfigRepository AppConfigIntegrationTest.appConfigRepository;
    
    @Test
    public void AppConfigIntegrationTest.testCount() {
    ...
    @Test
    public void AppConfigIntegrationTest.testFind() {
    ...
    @Test
    public void AppConfigIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to initialize correctly", dod.getRandomAppConfig());
        long count = appConfigRepository.count();
    ...
    @Test
    public void AppConfigIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to initialize correctly", dod.getRandomAppConfig());
        long count = appConfigRepository.count();
    ...
    @Test
    public void AppConfigIntegrationTest.testFlush() {
        AppConfig obj = dod.getRandomAppConfig();
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to provide an identifier", id);
    ...
    @Test
    public void AppConfigIntegrationTest.testSaveUpdate() {
        AppConfig obj = dod.getRandomAppConfig();
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to provide an identifier", id);
    ...
    @Test
    public void AppConfigIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to initialize correctly", dod.getRandomAppConfig());
    ...
    @Test
    public void AppConfigIntegrationTest.testDelete() {
        AppConfig obj = dod.getRandomAppConfig();
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'AppConfig' failed to provide an identifier", id);
