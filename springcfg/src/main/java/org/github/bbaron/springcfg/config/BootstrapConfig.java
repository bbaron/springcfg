...
public class BootstrapConfig {
	...
	@Bean
	public static PropertySourcesPlaceholderConfigurer applicationPlaceholderConfigurer(ApplicationContext ctx, Springcfg cfg) {
		PropertySourcesPlaceholderConfigurer pspc = new PropertySourcesPlaceholderConfigurer();
		String appCfgLocation = cfg.getApplicationName();
		logger.info("App Name = " + appCfgLocation);
		String appBase = ctx.getEnvironment().getProperty(APP_BASE_PROPERTY_NAME, CONFIG_ROOT);
